...
def merge_subwords(tree : Tree, last_leaf : Union[None, Tree]) -> Tuple[bool, Optional[Tree], Optional[Tree]]:
    if len(tree) == 1 and isinstance(tree[0], str):
        ...
        for i, child in enumerate(tree):
            ...
            c_del, last_leaf, uptree = merge_subwords(child, last_leaf)
        ...
        elif len(tree) == 1 and not isinstance(tree[0], str):
            return False, last_leaf, tree[0]
        
        else:
            return False, last_leaf, None   # set last_leaf to None if you want to 
                                            # prevent merging for subwords spanning several subtrees
